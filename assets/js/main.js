...
// Lấy tất cả các mục trong thanh navigation
const navLinks = document.querySelectorAll('.nav__link');

// Duyệt qua các mục và thêm sự kiện click
navLinks.forEach(link => {
  link.addEventListener('click', function() {
    // Xóa class 'active-link' khỏi tất cả các mục
    navLinks.forEach(item => item.classList.remove('active-link'));

    // Thêm class 'active-link' cho mục được click
